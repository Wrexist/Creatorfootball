 ...
 * in the original brand asset pass (commit 5451d47) and preserved in
 * `tools/brand/mark.path.txt`.
 *
 ...
 * F, so it needs `evenodd` for those counters to stay open.
 * Preserve this geometry when packaging the native monochrome icon.
 */
const MARK_PATH =
