 ...
 *
 * Starts `vite preview`, waits for it to respond, runs e2e/smoke.mjs, then
 * e2e/failure.mjs and e2e/recovery.mjs against it, forwards the first non-zero exit code, then
