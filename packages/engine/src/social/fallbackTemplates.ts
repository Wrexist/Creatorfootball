...
export const FALLBACK_SOCIAL_TEMPLATES: readonly SocialTemplate[] = [
  ...
  t('fs_red_cr_hype', 'RED_CARD', 'CREATOR', 'a player down. still fighting. {club} do not lie down for anyone', 0.2, 10, { tone: 'HYPE' }),
  ...
  // --- RESULTS ---
  t('fs_shock_fan1', 'SHOCK_DEFEAT', 'FAN', '{score}. against {opponent}. I want to speak to whoever is responsible', -0.9),
  ...
  t('fs_shock_cr_ana', 'SHOCK_DEFEAT', 'CREATOR', '{club} lost by {margin}. The staff will need to look closely at how they defended.', -0.4, 12, { tone: 'ANALYTICAL' }),
  ...
  t('fs_defeat_cr', 'DEFEAT', 'CREATOR', 'losing {score} against {opponent} hurts. the response matters now.', -0.4, 10, { tone: 'ANALYTICAL' }),
  ...
  t('fs_state_cr_hype', 'STATEMENT_WIN', 'CREATOR', '{club} just beat {opponent} by {margin}. WATCH OUT.', 0.9, 12, { tone: 'HYPE' }),
