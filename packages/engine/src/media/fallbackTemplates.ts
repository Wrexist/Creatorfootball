...
export const FALLBACK_MEDIA_TEMPLATES: readonly MediaTemplate[] = [
  ...
  { id: 'fm_red_2', trigger: 'RED_CARD', headline: 'Sent off: {player} walks in the {minute}th', body: '{club} finished the match short after {player} was dismissed. A {matches}-match ban follows, and the timing could hardly be worse.', outlets: ['The Touchline'], importance: 4, sentiment: -0.6, weight: 8 },
