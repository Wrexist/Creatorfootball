...
Hosted validation succeeded in run 36127001078: unsigned intermediate archive -> cloud distribution export -> strict signature/team/app/profile checks -> TestFlight upload. Apple independently lists 1.0.16 (13) as Processing. This validates the revised signing path for the current app without revoking any existing certificate.
